...
import { caregiver_deactive } from "../../store/reducer/caregiverReducer";

const DeActiveCaregiver = () => {
    ...
    useEffect(() => {
        ...
        dispatch(caregiver_deactive(obj));
    }, [parPage, currentPage, searchValue]);

    return (
        <div className="px-2 lg:px-7 pt-5">
            <h1 className="text-[20px] font-bold mb-3"> Caregiver DeActive</h1>
...
export default DeActiveCaregiver;
